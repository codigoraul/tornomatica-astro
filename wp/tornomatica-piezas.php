    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                ...
                'name'         => 'galeria',
                'type'         => 'repeater',
                'instructions' => 'Fotos adicionales de la pieza (además de la imagen destacada). El orden de las filas define el orden en la web. Arrastra el ⠿ para reordenar.',
                'layout'       => 'table',
                'button_label' => 'Agregar foto',
                'sub_fields'   => [
                    [
                        'key'           => 'field_pieza_galeria_imagen',
                        'label'         => 'Imagen',
                        'name'          => 'imagen',
                        'type'          => 'image',
                        'return_format' => 'url',
